...
const CASES: Case[] = [
  ...
  { name: "跨境西安-组长含管理", emp: { position: "cross_border_ops", region: "西安", level: "组长", perf_personal: 320, perf_team: 1600, span_of_control: 6 }, grade: "组长", salary: 24200, incentive: null },
  { name: "跨境西安-组长幅度不足", emp: { position: "cross_border_ops", region: "西安", level: "组长", perf_personal: 320, perf_team: 1600, span_of_control: 3 }, grade: "组长", salary: 21000, incentive: null },

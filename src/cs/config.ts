...
const JILIN_GROUPS: CsGroupConfig[] = [
  ...
  { dept: DY, group: "客服一/二组-售后组", ind1: sat(0.5), ind2: resp(0.5),
...
export const CS_CONFIGS: Record<CsPositionKey, CsPositionConfig> = {
  ...
  jilin_cs: {
    ...
    notes: [
      ...
      "各组指标权重均为 50% / 50%。",
      "组别须与部门匹配——天猫：售前服务组（官旗/综合）、物流速询组、标准/专业/优+服务组；抖音：客服一组-售前组、客服一/二组-售后组、客服一组-综合组（快手）、客服二组-综合组（京东）；拼多多：客服二组（售后）、客服一组-售前组、客服一组-综合组（售前+售后）。",
